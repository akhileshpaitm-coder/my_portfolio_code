...
import { deleteExpertiseAction } from "./actions";

/**
 * Delete button that opens a styled confirmation dialog before running
 * the delete server action (same pattern as DeleteSkillButton).
 */
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description={`"${title}" will be permanently removed from the expertise section. This action cannot be undone.`}
        confirmLabel="Delete"
        cancelLabel="Cancel"
        tone="danger"
      ...
      <form ref={formRef} action={deleteExpertiseAction} className="hidden">
